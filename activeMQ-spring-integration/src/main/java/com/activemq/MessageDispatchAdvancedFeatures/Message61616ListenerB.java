 ...
 * @version:1.0
 */
public class Message61616ListenerB implements MessageListener {
    @Override
    public void onMessage(Message message) {
        ...
        if (message instanceof TextMessage) {
            try {
                ...
                System.out.println("------------------------------------" +Thread.currentThread().getId()+
                        "Message61616ListenerB receive txt msg  from broker61616===" + queueMessageBo.getContent());
        ...
        if (message instanceof MapMessage) {
            try {
                ...
                QueueMessageBo queueMessageBo = JSON.parseObject(msgText, new TypeReference<QueueMessageBo>() {});
                System.out.println("-------------------------------------" +Thread.currentThread().getId()+
                        "Message61616ListenerB receive map msg from broker61616======" + queueMessageBo.getContent());
