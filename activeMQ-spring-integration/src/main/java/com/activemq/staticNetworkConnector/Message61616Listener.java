    ...
    public void onMessage(Message message) {
        ...
        if (message instanceof TextMessage) {
            try {
                ...
                System.out.println("receive txt msg  from broker61616===" + queueMessageBo.getContent());
        ...
        if (message instanceof MapMessage) {
            try {
                ...
                //会进行反序列化成对象，做进一步的处理
                QueueMessageBo queueMessageBo = JSON.parseObject(msgText, new TypeReference<QueueMessageBo>() {});
                System.out.println("receive map msg from broker61616======" + queueMessageBo.getContent());
